...
// normalization forms, the two full default case mappings over the pinned Unicode 16.0.0 data, and
// a bounded builder, declaring no grapheme segmentation, case folding, formatting, parsing, regex,
// or locale.
pub use text::{
