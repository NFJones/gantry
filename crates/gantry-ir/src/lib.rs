...
pub use package::{
    ...
    DependencyDeclaration, DependencyFingerprint, DependencyFingerprintError,
    DependencyInterfacePin, DependencyPin, DurableArtifactRelation, DurableArtifactReport,
