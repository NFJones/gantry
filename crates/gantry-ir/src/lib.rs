...
// codec categories of `GNT-29.9-codec-contract`, the canonical hex, base64, binary, and dynamic
// JSON codecs of `GNT-42.2-hex-codec`, `GNT-42.3-base64-codec`,
...
pub use codec::{
    ...
    JSON_DEPTH_BOUND, JSON_NODE_BOUND, JSON_TEXT_OCTET_BOUND, JsonValue, base64_decode,
    base64_encode, canonical_codec_hierarchy, declare_codec_surface, hex_decode, hex_encode,
