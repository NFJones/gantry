...
fn configuration_json(
    ...
    format!(
        ...
        json_string(&required.value_limits.list_item_limit().to_string()),
        json_string(&required.value_limits.string_scalar_limit().to_string()),
        json_string(&required.value_limits.nesting_depth_limit().to_string()),
        json_string(&required.value_limits.node_limit().to_string()),
