...
pub const DIAGNOSTIC_CODE_REGISTRY: &[DiagnosticCodeDefinition] = &[
    ...
    DiagnosticCodeDefinition {
        ...
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
        meaning: "A recorded artifact binding disagrees with the target inputs it must bind.",
    },
    DiagnosticCodeDefinition {
        code: "target-artifact-binding-missing-input",
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
        meaning: "A recorded artifact binding omits one of the inputs it must bind.",
    },
    DiagnosticCodeDefinition {
        code: "target-artifact-binding-property-duplicate",
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
        meaning: "An artifact-binding record carries one property twice.",
    },
    DiagnosticCodeDefinition {
        code: "target-artifact-binding-property-unknown",
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
        meaning: "An artifact-binding record carries a property its version does not define.",
    },
    DiagnosticCodeDefinition {
        code: "target-artifact-binding-version-unsupported",
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
    ...
    DiagnosticCodeDefinition {
        ...
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
        meaning: "A target-descriptor record carries one property twice.",
    },
    DiagnosticCodeDefinition {
        code: "target-descriptor-property-missing",
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
        meaning: "A target-descriptor record omits a property its version defines.",
    },
    DiagnosticCodeDefinition {
        code: "target-descriptor-property-unknown",
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
        meaning: "A target-descriptor record carries a property its version does not define.",
    },
    DiagnosticCodeDefinition {
        code: "target-descriptor-version-unsupported",
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
    ...
    DiagnosticCodeDefinition {
        ...
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
        meaning: "A feature enabling relation is cyclic.",
    },
    DiagnosticCodeDefinition {
        code: "target-feature-declaration-duplicate",
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
    ...
    DiagnosticCodeDefinition {
        ...
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
        meaning: "A semantic mode is not admitted for the selected target kind.",
    },
    DiagnosticCodeDefinition {
        code: "target-predicate-name-unknown",
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
    ...
    DiagnosticCodeDefinition {
        ...
        phase: DiagnosticPhase::Package,
        category: DiagnosticCategory::Package,
        meaning: "A target record carries a field value outside the closed vocabulary of its version.",
    },
    DiagnosticCodeDefinition {
