...
fn fs_replacement_publishes_no_staging_or_partial_object() {
    ...
    for rule in [
        ...
        "This paragraph publishes the success-outcome vocabulary alone: it adds no refusal, and a refusal a replacement is presented with stays the refusal its own clause declares",
        "the single-resolution and link rule of `GNT-47.8-filesystem-link-policy`, and the declared conditions of `GNT-47.12-filesystem-operation-refusals` each keep their own owner",
