...
members. `GNT-ASYNC-REL-001` adopts all six profiles on the qualified Linux
release cells while leaving hosted macOS and stable-media claims unqualified; see
